...
I completed it on newer version of dart and other packages so to get rid of a lot of issues, I created a new project and then copied the codes from starting repo and then have done all the TODO to complete the project.
